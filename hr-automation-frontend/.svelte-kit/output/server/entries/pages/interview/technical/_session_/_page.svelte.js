...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    head("1foioch", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>Technical Interview | HR Automation</title>`);
      });
    });
    ...
    if (interviewState === "checking") {
      ...
      if (interviewState === "ended") {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<div class="h-full flex flex-col items-center justify-center text-center p-4"><div class="w-20 h-20 rounded-full bg-emerald-900/50 flex items-center justify-center mb-6">`);
        Code($$renderer2, { class: "w-10 h-10 text-emerald-400" });
        $$renderer2.push(`<!----></div> <h1 class="text-2xl font-bold text-obsidian-100 mb-2">Interview Completed</h1> <p class="text-obsidian-400 mb-4">Your technical interview has been recorded and is being analyzed.</p> <p class="text-sm text-obsidian-500">Redirecting to results...</p></div>`);
      } else {
        $$renderer2.push("<!--[!-->");
        ...
        Code($$renderer2, { class: "w-5 h-5 text-royal-400" });
        $$renderer2.push(`<!----> <h1 class="font-semibold text-obsidian-100">Technical Interview</h1></div> <div class="flex items-center gap-2 px-3 py-1 rounded-full bg-obsidian-800">`);
        if (networkReady) {
          $$renderer2.push("<!--[-->");
        ...
        InterviewTimer($$renderer2, { duration, maxDuration: 3600 });
        $$renderer2.push(`<!----></header> <div class="flex-1 flex overflow-hidden"><div class="flex-1 relative p-4"><div class="h-full rounded-xl overflow-hidden bg-gradient-to-br from-royal-900 to-obsidian-900 flex items-center justify-center"><div class="text-center"><div class="w-32 h-32 rounded-full bg-royal-800/50 flex items-center justify-center mx-auto mb-4">`);
        Code($$renderer2, { class: "w-16 h-16 text-royal-400" });
        $$renderer2.push(`<!----></div> <h2 class="text-xl font-semibold text-obsidian-100">AI Interviewer</h2> <p class="text-obsidian-400 text-sm">Technical Assessment</p></div></div> <div class="absolute bottom-8 right-8 w-64 aspect-video rounded-lg overflow-hidden shadow-xl border-2 border-obsidian-700">`);
